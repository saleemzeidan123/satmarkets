...
export default function MarketingHome({ locale = "en", featured = [], stats, bands = [], jobs, kpis }: { locale?: string; featured?: FeaturedListing[]; stats: Stats; bands?: HeroBand[]; jobs?: { reqs: number | null; segs: number | null }; kpis: { period: string | null; source: string | null; stat: "average" | "median" | null; officeRent: number | null; retailRent: number | null; cells: number; districts: number } }) {
 ...
 const T = ar ? {
  ...
  stat: [[stats.listings, "عروض موثّقة"], [stats.verifiedPct, "موثّقة من المالك"], [stats.districts, "أحياء مفهرسة"], [stats.buildings, "مبانٍ"]] as [string | null, string][],
  exEye: "المنصّة",
  ...
  stat: [[stats.listings, "Verified listings"], [stats.verifiedPct, "Owner-verified"], [stats.districts, "Districts indexed"], [stats.buildings, "Buildings"]] as [string | null, string][],
  exEye: "The exchange",
