...
const FOOT_COLS: [string, string[]][] = [
  ...
  // says nothing about what a verification is. It now points at the page built
  // from the gate itself, and the two records beside it are published for the
  // same reason: a rule nobody can read is a rule nobody can hold us to.
  ["Trust and legal", ["How we verify", "Data sources", "Bilingual standards", "Terms of Service", "Privacy and PDPL", "Contact"]],
];
...
export default function SatFooter({ locale = "en" }: { locale?: string }) {
  const __T: Record<string, string> = {"FAL 1200025510":"فال 1200025510","Platform":"المنصة","AI and deals":"الذكاء والصفقات","Solutions":"الحلول","Company":"الشركة","Trust and legal":"الثقة والامتثال","Listings":"العروض","Requirements":"الطلبات","Rent Index":"مؤشر الإيجارات","Compare spaces":"قارن المساحات","Investment underwriting":"تحليل الاستثمار","Location Intelligence":"ذكاء الموقع","For owners":"للملّاك","Membership":"العضوية","AI Advisor":"المستشار الذكي","Deal room":"غرفة الصفقة","Messages":"الرسائل","Notifications":"الإشعارات","Floor plans":"المخططات","About SAT Real Estate":"عن سات العقارية","Help center":"مركز المساعدة","Occupiers":"المستأجرون","Owners and landlords":"الملّاك والمؤجرون","Brokers":"الوسطاء","Investors":"المستثمرون","Setting up an RHQ":"تأسيس مقر إقليمي","Our neutrality":"حيادنا","Newsroom":"غرفة الأخبار","Careers":"الوظائف","Contact":"تواصل","How we verify":"كيف نتحقق","Data sources":"مصادر البيانات","Bilingual standards":"المعايير ثنائية اللغة","Terms of Service":"شروط الخدمة","Privacy and PDPL":"الخصوصية وحماية البيانات","Security":"الأمان","List your space":"أدرج مساحتك","Browse listings":"تصفّح العروض","POWERED BY SAT REAL ESTATE":"مدعومة من سات العقارية","List, lease or invest, on the record.":"أدرج، أجّر، أو استثمر، استناداً إلى السجل.","Join owners, occupiers and licensed brokers across the Kingdom.":"انضم إلى الملّاك والمستأجرين والوسطاء المرخّصين في أنحاء المملكة.","Saudi Arabia's commercial leasing and sales exchange. Listings that show their verification state, published rent bands attributed to source, deals end to end.":"منصة سعودية للتأجير والبيع التجاري. عروض تُظهر حالة توثيقها، ونطاقات إيجار منشورة منسوبة إلى مصادرها، وصفقات متكاملة."};
  ...
  return (
    <footer className="foot">
      ...
      <div className="bottom">
        {/* Brand name only, no domain: the production domain is not yet acquired
            and the preview must not claim it (PKG-0A, Codex rank 34). Reintroduce
            it here only after acquisition and launch configuration. */}
