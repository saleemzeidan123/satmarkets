...
export default function SaveHeart({ id, label }: { id: string; label?: string }) {
  ...
  return (
    <button type="button" onClick={toggle} aria-label={label || "Save"} aria-pressed={saved}
      ...
      <svg width="18" height="18" viewBox="0 0 24 24" fill={saved ? "#3A6EA5" : "none"} stroke={saved ? "#3A6EA5" : "currentColor"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
