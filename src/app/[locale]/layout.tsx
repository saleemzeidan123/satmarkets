  ...
  return (
    <>
      ...
      <div className="topnotice" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, background: "#14181B", color: "#fff", padding: "8px 24px", fontSize: 12.5, flexWrap: "wrap" }}>
        ...
        <span style={{ color: "rgba(255,255,255,.86)" }}>{ar ? "مؤشر الإيجارات للربع الأول 2026 متاح الآن. معايير الرياض المنشورة، منسوبة إلى مصادرها." : "Rent Index Q1 2026 is live. Published Riyadh benchmarks, attributed to source."}</span>
