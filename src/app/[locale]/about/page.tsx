...
export default function AboutPage({ params }: { params: { locale: string } }) {
 ...
 const c = ar ? {
  ...
  intro: "سات ماركتس منصة مستقلة ومحايدة للذكاء العقاري التجاري والتأجير والبيع، تبدأ من الرياض. نجمع قوائم موثقة من الملّاك والوسطاء المرخّصين، ومسار معاينات متوافق، ومؤشر إيجار يدعم القرار، وخريطة ذكاء على مستوى المبنى، في منصة واحدة بالإنجليزية أولاً مع نسخة عربية كاملة وبحث ذكي مؤصَّل ببيانات موثقة.",
