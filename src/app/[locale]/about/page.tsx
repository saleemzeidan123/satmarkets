  ...
  <section className="mx-auto max-w-3xl">
   ...
   <Reveal>
    <div className="mt-10 grid gap-6 sm:grid-cols-2">
     {cards.map(([t,d])=>(
      <div key={t} className="card p-5"><h3 className="font-display text-lg text-charcoal">{t}</h3><p className="mt-1.5 text-[13.5px] leading-relaxed text-charcoal/70">{d}</p></div>
     ))}
    </div>
   </Reveal>
   <Reveal>
    <div className="mt-14">
     ...
     <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-charcoal/70">{c.verifySub}</p>
     <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {steps.map(([t,d],i)=>(
       <div key={t} className="card p-5">
        ...
        <p className="mt-1.5 text-[12.5px] leading-relaxed text-charcoal/70">{d}</p>
       </div>
      ))}
     </div>
     <p className="mt-4 text-[12px] leading-relaxed text-charcoal/65">{dict.about.acronyms}</p>
    </div>
   </Reveal>
