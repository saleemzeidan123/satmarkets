  ...
  const c = ar
    ? {
        ...
        commitments: [
          ...
          ["لا عمولة مفترضة", "تمثيل سات اختياري فقط، بموجب تفويض مكتوب منفصل. والمسار الافتراضي هو تواصل مباشر ومجاني بين الطرفين."],
          ...
          ["نُبلّغ عن ذلك", "نعتزم أن ننشر كل ربع سنة نسبة الصفقات التي شملت تمثيلاً من سات، حتى يكون التوازن ظاهراً للجميع. (مُخطّط له.)"],
        ],
