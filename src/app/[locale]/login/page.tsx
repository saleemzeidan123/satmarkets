   ...
   <div className="card p-7" style={{ boxShadow: "var(--sh-2)" }}>
    {step === "choose" && (
     <>
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-charcoal/40">{ar ? "التسجيل مجاني للباحثين عن مساحات: احفظ المفضّلة وتابع مراسلاتك مع المُعلنين." : "Free for occupiers: save favourites and keep your messages with listers."}</p>
