...
export default function PricingPage({ params }: { params: { locale: string } }) {
  ...
  const matrix: string[][] = [
    ...
    ["Featured boosts / mo", "—", "1", "5", "30", "Custom"],
    ...
    ["Location Intelligence / mo", "—", "2", "10", "50", "∞"],
  ...
  const cell = (v: string) => v === "yes" ? <span className="yes">✓</span> : v === "no" ? <span className="no">—</span> : <span className="tnum">{v}</span>;
  return (
