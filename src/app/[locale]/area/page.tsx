    ...
    <div style={{ padding: "8px 24px 48px" }}>
     <div className="card pad" style={{ boxShadow: "var(--sh-1)" }}>
      ...
      <div className="row gap10" style={{ marginTop: 18, paddingTop: 14, borderTop: "1px solid var(--silver)", alignItems: "flex-start" }}>
       ...
       <span className="muted" style={{ fontSize: 12.5, lineHeight: 1.55 }}>{ar ? "متوافق مع نظام حماية البيانات: تُعامَل بيانات الموقع كبيانات حسّاسة، مجهّلة ومجمّعة، مستضافة داخل المملكة، ومسجّلة لدى سدايا. أي مستشعرات تحمل اعتماد هيئة الاتصالات والفضاء والتقنية. لا صور شخصية، أبداً." : "PDPL-native: location data is treated as sensitive, anonymised and aggregated, hosted in the Kingdom, registered with SDAIA. Any sensors carry CST type-approval. No personal images, ever."}</span>
      </div>
     </div>
    </div>
   </div>
